                            ...
                            <div className="flex-1 overflow-y-auto custom-scrollbar p-8">
                                ...
                                <div className="flex justify-end gap-3 mb-8 items-start">
                                    <button
                                        ...
                                        className="px-6 py-3 bg-white/[0.03] hover:bg-blue-500/10 border border-white/10 hover:border-blue-500/30 rounded-2xl flex flex-col items-center justify-center transition-all cursor-pointer group/readiness relative overflow-hidden"
                                    >
                                        <div className="absolute inset-0 bg-blue-500/5 opacity-0 group-hover/readiness:opacity-100 transition-opacity" />
                                        <span className="text-lg font-black text-white leading-none relative z-10">
                                        ...
                                        <div className="mt-1.5 flex items-center gap-1.5 relative z-10">
                                            <div className={`w-1.5 h-1.5 rounded-full animate-pulse ${readiness?.score >= 80 ? 'bg-emerald-500' : readiness?.score >= 40 ? 'bg-amber-500' : 'bg-rose-500'}`} />
                                            <span className="text-[8px] font-black text-slate-500 uppercase tracking-widest group-hover/readiness:text-blue-400 transition-colors">READINESS SCORE</span>
                                        </div>
                                    </button>
                                    <div className="px-4 py-2 bg-amber-500/10 border border-amber-500/20 rounded-full flex items-center gap-2 text-[10px] font-black text-amber-500 uppercase tracking-widest mt-1">
