    ...
    <PageLayout>
      <div className="flex flex-col items-center justify-center min-h-[70vh] text-center px-4 relative">
        ...
        >
          ...
          <div className="relative w-32 h-32 rounded-[2.5rem] bg-slate-100 dark:bg-white/5 border border-slate-300 dark:border-slate-200 dark:border-white/10 flex items-center justify-center text-blue-400 mb-10 mx-auto shadow-2xl backdrop-blur-xl group">
        ...
        >
          ...
          <Link
            to="/"
            className="bg-white text-black px-12 py-5 rounded-3xl font-black text-[10px] tracking-widest uppercase hover:bg-slate-200 transition-all shadow-xl shadow-white/5 active:scale-95 flex items-center gap-3 mx-auto w-fit border border-slate-300 dark:border-slate-200 dark:border-white/10"
          >
