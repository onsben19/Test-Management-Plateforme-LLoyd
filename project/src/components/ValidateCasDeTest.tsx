            ...
            <form onSubmit={handleSubmit} className="flex flex-col overflow-hidden">
                <div className="p-6 pt-2 overflow-y-auto custom-scrollbar space-y-6">
                    ...
                    <div className="bg-[#1e293b] p-1 rounded-xl flex gap-1">
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-black tracking-wider uppercase transition-colors ${testCaseForm.executionType === 'ai' ? 'bg-[#1e293b] text-slate-300 border border-white/5' : 'text-[#64748b] hover:text-slate-300'}`}
                        >
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-black tracking-wider uppercase transition-colors ${testCaseForm.executionType === 'manual' ? 'bg-[#3b82f6] text-white shadow-[0_0_15px_rgba(59,130,246,0.4)]' : 'text-[#64748b] hover:text-slate-300'}`}
                        >
                    ...
                    {testCaseForm.executionType === 'manual' ? (
                        <div className="space-y-6 animate-fade-in">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <button
                                        ...
                                        className={`p-5 rounded-2xl border-2 flex items-center justify-center gap-3 transition-all ${testCaseForm.status === 'PASSED' ? 'bg-emerald-500/10 border-emerald-500 text-emerald-400 shadow-lg shadow-emerald-500/10' : 'bg-[#1e293b]/50 border-transparent text-slate-500 hover:bg-[#1e293b]'}`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`p-5 rounded-2xl border-2 flex items-center justify-center gap-3 transition-all ${testCaseForm.status === 'FAILED' ? 'bg-rose-900/40 border-rose-500 text-rose-400 shadow-lg shadow-rose-500/10' : 'bg-[#1e293b]/50 border-transparent text-slate-500 hover:bg-[#1e293b]'}`}
                                    >
                            ...
                            {testCaseForm.status === 'FAILED' && (
                                <div className="bg-[#1e293b]/30 border border-rose-500/50 rounded-2xl p-6 space-y-6 animate-fade-in">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <textarea 
                                        ...
                                        className="w-full bg-[#1e293b] border border-[#334155] text-[#f1f5f9] rounded-lg px-4 py-3 outline-none focus:border-orange-500/50 transition-colors min-h-[120px] text-sm pr-16"
                                    />
                                    <button
                                        type="button"
                                        onClick={async () => {
                                        ...
                                        className={`absolute bottom-3 right-3 p-2 rounded-xl border flex items-center justify-center transition-all bg-white shadow-md ${isReformulating ? 'opacity-50 cursor-not-allowed' : 'hover:scale-105 cursor-pointer'}`}
                                        title="Reformuler avec l'IA"
                                    >
                                        {isReformulating ? (
                                            <div className="w-5 h-5 border-2 border-emerald-500 border-t-transparent rounded-full animate-spin" />
                                        ) : (
                                            <div className="flex items-center gap-1.5 text-emerald-600 font-bold px-1">
                                                <Sparkles className="w-4 h-4" />
                                                <span className="text-[10px] tracking-wider uppercase">G</span>
                                            </div>
                                        )}
                                    </button>
                                </div>
                                        ...
                                        <div className="bg-[#162032] border-b border-[#334155] px-4 py-3 flex items-center justify-between">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <button 
                                                    ...
                                                    onClick={handleGenerateScript}
                                                    disabled={generatingCode}
                                                    className="flex items-center gap-1.5 px-3 py-1.5 bg-[#0f172a] border border-[#334155] text-emerald-500 hover:text-emerald-400 rounded text-xs font-medium transition-colors disabled:opacity-50"
