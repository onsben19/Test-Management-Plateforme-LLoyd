...
const QANewsHub: React.FC = () => {
    ...
    return (
        <div className="relative overflow-hidden bg-[#0A0F1C] border border-white/5 rounded-3xl p-10 shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)]">
            ...
            <div className="relative flex items-center justify-between mb-12 border-b border-white/5 pb-8">
                <div>
                    <h2 className="text-3xl font-light text-slate-100 tracking-wide">
                        {t('Intelligence')} <span className="font-semibold text-blue-400">Hub</span>
                    </h2>
                ...
                <button 
                    onClick={fetchNews}
                    className="group p-4 rounded-full bg-white/[0.02] hover:bg-white/[0.05] transition-all duration-500 text-slate-400 hover:text-slate-200 border border-white/5 active:scale-90"
                    disabled={loading}
                    title={t("Actualiser")}
                >
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-2 gap-6">
                {news.map((item, index) => (
                    <motion.div
                        ...
                        className="group bg-white/[0.01] border border-white/5 rounded-2xl p-8 hover:bg-white/[0.03] hover:border-blue-500/30 transition-all duration-500 flex flex-col h-full cursor-pointer relative overflow-hidden"
                    >
                        ...
                        <h3 className="relative text-lg font-medium text-slate-200 mb-6 leading-relaxed group-hover:text-blue-300 transition-colors">
                            {item.title}
                        </h3>
                        ...
                        <div className="relative mt-8 pt-6 border-t border-white/5 flex items-center justify-between text-[11px] font-medium text-slate-500">
