...
test('jgjh', async ({ page }) => {
  ...
  const secureAreaText = page.locator('h2, [role="heading"], h1[class*="heading"], h2[class*="heading"], h3[class*="heading"], h4[class*="heading"], h5[class*="heading"], h6[class*="heading"], [role="heading"][class*="heading"], span[class*="heading"], p[class*="heading"]');
  await expect(secureAreaText.first()).toBeVisible({ timeout: 10000 });
  await expect(secureAreaText.first()).toContainText('Secure Area', { timeout: 10000 });
});