...
test('xv', async ({ page }) => {
  ...
  const errorLocator = page.locator('div.error, span.error, h1[class*="error"], h2[class*="error"], h3[class*="error"], h4[class*="error"], h5[class*="error"], h6[class*="error"], [role="heading"][class*="error"], span[class*="error"], p[class*="error"]');
